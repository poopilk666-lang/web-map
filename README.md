# web-map[web_map.html](https://github.com/user-attachments/files/25836209/web_map.html)
<!-- 1. วาดโครงสร้าง html -->
...
// สร้างชั้นข้อมูลใหม่และกำหนดให้อยู่ใน 'vectorPane' ที่เราสร้างไว้ในขั้นตอนที่ 2
        ...
        // popup
        marker_a.bindPopup(
    "<b>ชื่อสถานที่:</b> จุดตัวอย่าง<br>" +
    "<b>รายละเอียด:</b> พิกัด 15,100<br>" +
    "<img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQs8wWu7CFyvtLPnz2CQ132HgTr2hFctAd-IQ&s'>"
);

// นครราชสีมา
var marker_b = L.marker([14.9799, 102.0977], {
    icon: createMarker("blue")
}).addTo(map);

marker_b.bindPopup(
    "<b>จังหวัด:</b> นครราชสีมา<br>" +
    "<b>รายละเอียด:</b> Korat City<br>" +
    "<img src='https://cdn.spsmartvan.com/wp-content/uploads/2025/03/Nakhon-Ratchasima.webp'>"
);


// ร้อยเอ็ด
var marker_c = L.marker([16.0567, 103.6531], {
    icon: createMarker("green")
}).addTo(map);

marker_c.bindPopup(
    "<b>จังหวัด:</b> ร้อยเอ็ด<br>" +
    "<b>รายละเอียด:</b> Roi Et<br>" +
    "<img src='https://wecitizensthailand.com/wp-content/uploads/2024/10/R6_20827-1024x683.jpg'>"
);


// เชียงใหม่
var marker_d = L.marker([18.7883, 98.9853], {
    icon: createMarker("orange")
}).addTo(map);

marker_d.bindPopup(
    "<b>จังหวัด:</b> เชียงใหม่<br>" +
    "<b>รายละเอียด:</b> Chiang Mai<br>" +
    "<img src='https://static.thairath.co.th/media/dFQROr7oWzulq5Fa6ri8EY1PtBj4duWBmBXF0bOoQl9FJjbK5jDCw9s7IxFvwdxAc6U.jpg'>"
);


// พัทลุง
var marker_e = L.marker([7.6179, 100.0779], {
    icon: createMarker("purple")
}).addTo(map);

marker_e.bindPopup(
    "<b>จังหวัด:</b> พัทลุง<br>" +
    "<b>รายละเอียด:</b> Phatthalung<br>" +
    "<img src='https://www.chillpainai.com/src/wewakeup/scoop/images/44d67d3ee981f02a7c5729717c5f9b4f6c265b4d.jpg'>"
);
